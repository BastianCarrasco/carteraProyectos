<template>
  <div class="container">
    <header class="header">
      <h1 class="title">Proyectos de Investigación</h1>
      <div class="controls">
        ...
        <div class="filter-controls">
          ...
          <button @click="toggleSort" class="sort-button" aria-label="Cambiar orden">
      ...
      <div class="project-list">
        ...
        >
          ...
          <div class="project-body">
            <div class="info-grid">
                <div class="info-item">
                <h3 class="info-label">Jefes de proyecto</h3>
                <p class="info-content">{{ proyecto.jefes.length > 0 ? formatList(proyecto.jefes) : 'No hay jefes asignados' }}</p>
              </div>
              <div class="info-item">
                <h3 class="info-label">Académicos asociados</h3>
                <p class="info-content">{{ formatList(proyecto.academicos) || 'No especificado' }}</p>
              </div>
              ...
              <div class="info-item">
                ...
                <p class="info-content">{{ proyecto.UA || 'No especificada' }}</p>
              </div>

              <div class="info-item">
                <h3 class="info-label">Monto total</h3>
                <p class="info-content">{{ formatCurrency(proyecto.montoTotal) }}</p>
              </div>
              ...
              <div class="info-item full-width">
                ...
                <p class="info-content">{{ formatList(proyecto.convocatorias) || 'No especificadas' }}</p>
              </div>
            ...
            <div class="project-footer" v-if="proyecto.enlaces || proyecto.documentos">
...
const groupedProjects = computed(() => {
  ...
  props.proyectos.forEach((proyecto) => {
    ...
    if (proyecto.Convocatoria) grouped[proyecto.nombre].convocatorias.add(proyecto.Convocatoria);

    // Fusionar enlaces y documentos si existen en proyectos duplicados
    if (proyecto.enlaces) {
      grouped[proyecto.nombre].enlaces = [...grouped[proyecto.nombre].enlaces, ...proyecto.enlaces];
    }
    if (proyecto.documentos) {
      grouped[proyecto.nombre].documentos = [...grouped[proyecto.nombre].documentos, ...proyecto.documentos];
    }
  });
